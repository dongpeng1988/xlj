...
class TransUtilsWindow:EditorWindow
{

    [MenuItem("Build/TransUtilsWindow")]
    static void openZoneWindow()
    {
        TransUtilsWindow aa = (TransUtilsWindow)EditorWindow.GetWindow(typeof(TransUtilsWindow));
        aa.Show();
    }
...
// /////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void CreateRandomizeTransformWindow()
    {
        ...
        if (GUILayout.Button("Randomize Position"))
        {
            ...
            {
                Vector3 tmp = new Vector3();
                tmp.x = xCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.position.x;
                tmp.y = yCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.position.y;
                tmp.z = zCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.position.z;
        ...
        if (GUILayout.Button("Randomize Rotation"))
        {
            ...
            {
                Vector3 tmp = new Vector3();
                tmp.x = xCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.rotation.eulerAngles.x;
                tmp.y = yCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.rotation.eulerAngles.y;
                tmp.z = zCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.rotation.eulerAngles.z;
                Quaternion tmp2 = t.rotation;
                tmp2.eulerAngles = tmp;
        ...
        if (GUILayout.Button("Randomize Local Scale"))
        {
            ...
            {
                Vector3 tmp = new Vector3();
                tmp.x = xCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.localScale.x;
                tmp.y = yCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.localScale.y;
                tmp.z = zCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : t.localScale.z;
    ...
    private void CreateAddNoiseToTransformWindow()
    {
        ...
        if (GUILayout.Button("Add noise to Position"))
        {
            ...
            {
                Vector3 tmp = new Vector3();
                tmp.x = xCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : 0;
                tmp.y = yCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : 0;
                tmp.z = zCheckbox ? UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : 0;
        ...
        if (GUILayout.Button("Add noise to Rotation"))
        {
            ...
            {
                Vector3 tmp = new Vector3();
                tmp.x = xCheckbox ? t.rotation.eulerAngles.x + UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : 0;
                tmp.y = yCheckbox ? t.rotation.eulerAngles.y + UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : 0;
                tmp.z = zCheckbox ? t.rotation.eulerAngles.z + UnityEngine.Random.Range(randomRangeMin, randomRangeMax) : 0;
